...
def VGG16(include_top=False, weights='imagenet',
    ...
    if include_top:
        ...
        mddel.add(Flatten(name='flatten'))
    ...
    model.add(Dropout(rate=0.5,name='fc_dropout_1'))
    model.add(Dense(4096, activation='relu',name='fc2'))
    model.add(Dropout(rate=0.5,name='fc_dropout_2'))
    model.add(Dense(classes, activation='sigmoid',name='fc_multi_label'))


    for layer in model.layers:
        if 'block5' not in layer.name and 'fc' not in layer.name:
            layer.trainable = False

    return model


model = VGG16(classes=17)
